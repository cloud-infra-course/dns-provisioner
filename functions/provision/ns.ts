...
export const onRequest: PagesFunction<Env> = async (context) => {
  // Disable until Assignment 2 release to avoid NS/A conflicts
  if (new Date() < new Date('2024-01-19T00:00:00.000Z')) {
    return new Response(null, { status: 501, statusText: 'Disabled until further notice' })
  }
