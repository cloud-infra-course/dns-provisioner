...
function provisionNameServers() {
  ...
  fetch('/a3/request', {
    ...
    .then(function (responsePayload) {
      ...
      openPopup('Success', 'A request has successfully been made to your Yoctogram deployment. Please find the random code (flag) in the user agent parameter for the request in your Datadog console.')
